//
//  GenreSectionTitleCollectionReusableView.swift
...
class GenreSectionHeaderCollectionReusableView: UICollectionReusableView {
  static let reuseIdentifier = String(describing: GenreSectionHeaderCollectionReusableView.self)
