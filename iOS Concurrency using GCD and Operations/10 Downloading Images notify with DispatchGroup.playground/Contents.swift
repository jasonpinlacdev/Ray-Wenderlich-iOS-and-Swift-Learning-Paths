...
for id in ids {
  ...
  dataTask_Group(with: url, group: group) { data, response, error in
    // this closer is passed into and executed into the urlSession.dataTask's completion handler
...
group.notify(queue: queue) {
  print("All images have finished downloading off of background threads!")
  images
}
